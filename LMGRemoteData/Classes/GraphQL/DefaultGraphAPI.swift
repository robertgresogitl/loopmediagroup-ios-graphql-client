...
public final class OfferDetailsQuery: GraphQLQuery {
  ...
  public var queryDocument: String { return operationDefinition.appending(OfferDetails.fragmentDefinition).appending(BusinessListItem.fragmentDefinition).appending(BusinessListCategoryItem.fragmentDefinition).appending(OfferLocationItem.fragmentDefinition) }
...
public final class BusinessesListQuery: GraphQLQuery {
  ...
  public var queryDocument: String { return operationDefinition.appending(BusinessListItem.fragmentDefinition).appending(BusinessListCategoryItem.fragmentDefinition).appending(LocationItem.fragmentDefinition).appending(OfferListItem.fragmentDefinition) }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("businessFeed", arguments: ["cursor": GraphQLVariable("cursor"), "q": GraphQLVariable("q"), "bookmarkedOffersOnly": GraphQLVariable("bookmarked"), "orderingGeoPoint": GraphQLVariable("orderPoint")], type: .nonNull(.object(BusinessFeed.selections))),
    ]
...
public final class CollectionBusinessesListQuery: GraphQLQuery {
  ...
  public var queryDocument: String { return operationDefinition.appending(BusinessListItem.fragmentDefinition).appending(BusinessListCategoryItem.fragmentDefinition).appending(CollectionLocationItem.fragmentDefinition).appending(OfferListItem.fragmentDefinition) }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Collection: GraphQLSelectionSet {
      ...
      public static let selections: [GraphQLSelection] = [
        GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
        GraphQLField("businessFeed", arguments: ["cursor": GraphQLVariable("cursor"), "orderingGeoPoint": GraphQLVariable("orderPoint"), "limit": GraphQLVariable("limit")], type: .nonNull(.object(BusinessFeed.selections))),
      ]
      ...
      public struct BusinessFeed: GraphQLSelectionSet {
        ...
        public struct Business: GraphQLSelectionSet {
          ...
          public struct Location: GraphQLSelectionSet {
            ...
            public static let selections: [GraphQLSelection] = [
              GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
              GraphQLFragmentSpread(CollectionLocationItem.self),
            ]
            ...
            public struct Fragments {
              ...
              public var collectionLocationItem: CollectionLocationItem {
                get {
                  return CollectionLocationItem(unsafeResultMap: resultMap)
                }
                set {
                  resultMap += newValue.resultMap
                }
...
public final class LocationsListQuery: GraphQLQuery {
  ...
  public var queryDocument: String { return operationDefinition.appending(LocationsLocationItem.fragmentDefinition).appending(LocationsBusinessListItem.fragmentDefinition).appending(BusinessListCategoryItem.fragmentDefinition) }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct LocationFeed: GraphQLSelectionSet {
      ...
      public struct Location: GraphQLSelectionSet {
        ...
        public static let selections: [GraphQLSelection] = [
          GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
          GraphQLFragmentSpread(LocationsLocationItem.self),
        ...
        public struct Fragments {
          ...
          public var locationsLocationItem: LocationsLocationItem {
            get {
              return LocationsLocationItem(unsafeResultMap: resultMap)
            }
            set {
              resultMap += newValue.resultMap
            }
        ...
        public struct Business: GraphQLSelectionSet {
          ...
          public static let selections: [GraphQLSelection] = [
            GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
            GraphQLFragmentSpread(LocationsBusinessListItem.self),
          ]
          ...
          public struct Fragments {
            ...
            public var locationsBusinessListItem: LocationsBusinessListItem {
              get {
                return LocationsBusinessListItem(unsafeResultMap: resultMap)
              }
              set {
                resultMap += newValue.resultMap
              }
...
public struct OfferListItem: GraphQLFragment {
  ...
  public init(id: GraphQLID, headline: String, subhead: String, flags: [String], isBookmarked: Bool, heroImages: [HeroImage]) {
    self.init(unsafeResultMap: ["__typename": "Offer", "id": id, "headline": headline, "subhead": subhead, "flags": flags, "isBookmarked": isBookmarked, "heroImages": heroImages.map { (value: HeroImage) -> ResultMap in value.resultMap }])
  }
...
public struct BusinessListItem: GraphQLFragment {
  ...
  public init(id: GraphQLID, name: String, shortName: String, profileImages: [ProfileImage], categories: [Category]) {
    self.init(unsafeResultMap: ["__typename": "Business", "id": id, "name": name, "shortName": shortName, "profileImages": profileImages.map { (value: ProfileImage) -> ResultMap in value.resultMap }, "categories": categories.map { (value: Category) -> ResultMap in value.resultMap }])
  }
  ...
  public struct Category: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
      GraphQLFragmentSpread(BusinessListCategoryItem.self),
    ]
    ...
    public struct Fragments {
      ...
      public var businessListCategoryItem: BusinessListCategoryItem {
        get {
          return BusinessListCategoryItem(unsafeResultMap: resultMap)
        }
        set {
          resultMap += newValue.resultMap
        }
...
public struct BusinessListCategoryItem: GraphQLFragment {
  public static let fragmentDefinition =
  ...
  public init(id: GraphQLID, iconSmallImages: [IconSmallImage]) {
    self.init(unsafeResultMap: ["__typename": "Category", "id": id, "iconSmallImages": iconSmallImages.map { (value: IconSmallImage) -> ResultMap in value.resultMap }])
  }
...
public struct LocationItem: GraphQLFragment {
  ...
  public struct Address: GraphQLSelectionSet {
    ...
    public init(id: GraphQLID, suite: String? = nil, building: String? = nil, streetAddress: String? = nil, street: String? = nil, postalcode: String? = nil, city: String, state: String, country: String, centre: [Double]) {
...
public struct CollectionLocationItem: GraphQLFragment {
  public static let fragmentDefinition =
  ...
  public init(id: GraphQLID, name: String, distance: Double? = nil, address: Address) {
    self.init(unsafeResultMap: ["__typename": "Location", "id": id, "name": name, "distance": distance, "address": address.resultMap])
  }
