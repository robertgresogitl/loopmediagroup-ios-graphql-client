...
public struct LocationsLocationItem: GraphQLFragment {
  ...
  public init(id: GraphQLID, name: String, url: String? = nil, address: Address) {
    self.init(unsafeResultMap: ["__typename": "Location", "id": id, "name": name, "url": url, "address": address.resultMap])
  }
